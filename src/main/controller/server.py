...
app = Flask(__name__,
            static_url_path='', 
            static_folder='src/main/structure/view/static',
            template_folder='src/main/structure/view/templates')
...
def admin():
    html_file= open("src/main/structure/view/templates/admin.html", "r") #Leitura do arquivo upload.html para exibição deste na página
    html = html_file.read()
